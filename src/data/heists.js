...
const LOCATIONS = [
  {
    ...
    base: 0.55, loot: [3_000, 8_000], fine: 7_000, jailHours: 5, cooldownH: 12, heat: 8,
  ...
  },
  {
    ...
    base: 0.50, loot: [9_000, 24_000], fine: 20_000, jailHours: 9, cooldownH: 12, heat: 12,
  ...
  },
  {
    ...
    base: 0.42, loot: [40_000, 110_000], fine: 70_000, jailHours: 18, cooldownH: 12, heat: 22,
  ...
  },
  {
    ...
    base: 0.38, loot: [90_000, 240_000], fine: 180_000, jailHours: 24, cooldownH: 18, heat: 28,
  ...
  },
  {
    ...
    base: 0.32, loot: [200_000, 520_000], fine: 250_000, jailHours: 36, cooldownH: 18, heat: 38,
  ...
  },
  {
    ...
    base: 0.26, loot: [450_000, 1_100_000], fine: 500_000, jailHours: 48, cooldownH: 40, heat: 50,
  ...
  },
  {
    ...
    preps: ['auskundschaften', 'insider', 'fluchtwagen', 'funk', 'stoersender', 'sprengung',
      'schmiere', 'hehler'],
    base: 0.20, loot: [900_000, 2_400_000], fine: 900_000, jailHours: 72, cooldownH: 72, heat: 65,
