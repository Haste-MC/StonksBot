...
module.exports = [
  {
    ...
    lines: [
      ...
      '📏 Gemessen, nicht geschätzt: Musik+Creator mit 8 h am Tag verdient im ersten Jahr 149.415/Tag (vorher gemessen 100.916 – das alte Messskript ließ Stunden liegen, und die alte Erschöpfung drückte einen normalen Tag dauerhaft). 16 h bringen 329.875, bis zur Wand 369.752; wer jeden zweiten Tag marathont, landet bei 133.796 – weniger als 12 ruhige Stunden (234.731).',
    ],
  },
  {
    version: '1.32.1',
