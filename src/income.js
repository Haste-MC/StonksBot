 ...
 *
 * Bewusst klein gehalten: `!daily` soll den Einstieg ermöglichen, nicht das
 * Arbeiten ersetzen. Zum Vergleich: eine Job-Schicht bringt 70–800 pro Lauf.
 */

const DAY_MS = 24 * 60 * 60 * 1000;

/** Fester Sockel plus Zufallsanteil – die Spanne ist die Balance-Stellschraube. */
const DAILY = { base: 500, bonus: 500, cooldownMs: DAY_MS };
 ...
 *
 * @returns {Promise<{ok:boolean, amount?:number, balance?:object, remainingMs?:number}>}
 */
...
module.exports = { DAY_MS, DAILY, remainingMs, daily, formatRemaining };
